...
const CHANGELOG: string[] = [
  'قوانینِ پیشرفته‌ی کارکرد: ارفاقِ تأخیرِ صبح، دفعاتِ مجازِ تأخیر در ماه، حداقلِ اضافه‌کار، و کسرِ زمانِ استراحت (صبحانه/ناهار)',
  'این قوانین مستقیم در محاسبه‌ی حقوق و سندِ حسابداریِ حقوق اعمال می‌شوند',
];
      ...
      {showLeftDrawer && (
        <div className="drawer-overlay" onClick={() => setShowLeftDrawer(false)}>
          <aside className="drawer drawer-left" onClick={e => e.stopPropagation()}>
            ...
            <div className="drawer-foot">نسخه ۱۴۰۵ · ۱.۰.۵۸</div>
          </aside>
        </div>
      )}
