...
const CHANGELOG: string[] = [
  'انواعِ مرخصی/مجوز را خودتان می‌سازید (کمبوباکسِ قابلِ افزودن) و رفتارِ حقوقیِ هرکدام را تعیین می‌کنید: با حقوق/بدون حقوق و از مانده',
  'کارکردِ روزانه با ترددِ ورود/خروج: محاسبه‌ی تأخیر، تعجیل، کسرِ کار و مازادِ حضور بر اساسِ قوانینِ کاری',
  'محاسبه‌ی حقوق یکپارچه: مرخصیِ با حقوق به حقوق اضافه و کسرِ کار/بدون حقوق از حقوق کم می‌شود؛ فیشِ حقوقی کامل‌تر',
];
      ...
      {showLeftDrawer && (
        <div className="drawer-overlay" onClick={() => setShowLeftDrawer(false)}>
          <aside className="drawer drawer-left" onClick={e => e.stopPropagation()}>
            ...
            <div className="drawer-foot">نسخه ۱۴۰۵ · ۱.۰.۵۵</div>
          </aside>
        </div>
      )}
