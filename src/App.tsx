...
const CHANGELOG: string[] = [
  'آموزشِ تصویریِ صندوق در اولین استفاده (هر گزینه روشن و توضیح داده می‌شود)',
  'ماشین‌حسابِ صندوق بر اساس سهم و تعدادِ پرداختِ ماهانه',
  'بخشِ «گزارش صندوق» اگر صندوقی نباشد، پیامِ راهنما نشان می‌دهد (دیگر آنجا صندوق ساخته نمی‌شود)',
  'بهبودِ آیکون (حاشیه‌ی بیشتر تا گوشه‌ها بریده نشود)',
];
      ...
      {showLeftDrawer && (
        <div className="drawer-overlay" onClick={() => setShowLeftDrawer(false)}>
          <aside className="drawer drawer-left" onClick={e => e.stopPropagation()}>
            ...
            <div className="drawer-foot">نسخه ۱۴۰۵ · ۱.۰.۲۵</div>
          </aside>
        </div>
      )}
