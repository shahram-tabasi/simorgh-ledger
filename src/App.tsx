...
const CHANGELOG: string[] = [
  'حسابداری: کدینگِ استانداردِ سلسله‌مراتبی (گروه/کل/معین) با درختِ حساب‌ها و چارتِ کاملِ پیش‌فرض',
  'ثبتِ سریع برای غیرِحسابدار: فروش، خرید، دریافت، پرداخت، انتقالِ نقد/بانک، آورده‌ی سرمایه — با پیش‌نمایشِ سند',
  'مالیات بر ارزش افزوده در فروش/خرید (نرخ قابلِ تنظیم) و سندِ خودکارِ متوازن',
];
      ...
      {showLeftDrawer && (
        <div className="drawer-overlay" onClick={() => setShowLeftDrawer(false)}>
          <aside className="drawer drawer-left" onClick={e => e.stopPropagation()}>
            ...
            <div className="drawer-foot">نسخه ۱۴۰۵ · ۱.۰.۵۹</div>
          </aside>
        </div>
      )}
