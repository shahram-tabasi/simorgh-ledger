...
const CHANGELOG: string[] = [
  'فرمِ درخواستِ کارمند مثلِ کسری: انتخابِ دومرحله‌ای «نوعِ مجوز» (دسته) ← «مجوز» و گروه‌بندیِ انواع',
  'فیلدهای بیشتر در درخواست: از ساعت/تا ساعت (ساعتی)، جانشین، و مبدا/مقصد/موضوع برای مأموریت',
  'هر نوعِ مجوز یک «نوعِ مجوز» (دسته) دارد که قابلِ تعریف است؛ مجوزهای پیش‌فرضِ بیشتر (خروج، مازادِ حضور و…)',
];
      ...
      {showLeftDrawer && (
        <div className="drawer-overlay" onClick={() => setShowLeftDrawer(false)}>
          <aside className="drawer drawer-left" onClick={e => e.stopPropagation()}>
            ...
            <div className="drawer-foot">نسخه ۱۴۰۵ · ۱.۰.۵۷</div>
          </aside>
        </div>
      )}
