...
const CHANGELOG: string[] = [
  'اجزای حکمِ کارگزینی: حق مسکن، بنِ کارگری، حق اولاد، حق سنوات، فوق‌العادهٔ شغل، حق تأهل و بیمه — قابلِ تعریف و افزودن',
  'مبلغِ هر جزء برای هر کارمند در حکم ثبت می‌شود و در فیش و حقوقِ ماهانه و حسابداری اعمال می‌گردد',
];
      ...
      {showLeftDrawer && (
        <div className="drawer-overlay" onClick={() => setShowLeftDrawer(false)}>
          <aside className="drawer drawer-left" onClick={e => e.stopPropagation()}>
            ...
            <div className="drawer-foot">نسخه ۱۴۰۵ · ۱.۰.۵۶</div>
          </aside>
        </div>
      )}
